...
routes.get('/heroi/buscar/:name', CharacterController.SearchCharacter)
routes.get('/quadrinho/contar', ComicController.CountComic)
routes.get('/quadrinho/series/:name', CreatorController.SearchCreatorSeries)
routes.get('/quadrinho/buscar/:name', CreatorController.SearchCreator)
